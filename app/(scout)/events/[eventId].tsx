...
export default function EventDetailScreen() {
  ...
  const { isRegistered, participantCount, toggleAttendance } = useEventAttendance(eventId || '');
        ...
        <View style={styles.bottomBarContent}>
          <View style={styles.bottomBarInfo}>
            <ThemedText type="defaultSemiBold" style={styles.bottomBarTitle}>
              {isRegistered ? 'Tu es inscrit !' : "S'inscrire à l'événement"}
            </ThemedText>
          ...
          >
            {isRegistered ? (
              <>
                ...
                <Text style={styles.attendanceButtonText}>Inscrit</Text>
              </>
            ) : (
